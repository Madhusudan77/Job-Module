...
//for contractor
add_action('wp_ajax_verify_user_function', 'verify_user_function', 0);
add_action('wp_ajax_nopriv_verify_user_function', 'verify_user_function');
function verify_user_function() {
    $new_user_email = stripcslashes($_POST['new_user_email']);
    $number = stripcslashes($_POST['number']);
    $to = $new_user_email;
    $subject = 'Verification';
    $body = 'The OTP is'.$number;
